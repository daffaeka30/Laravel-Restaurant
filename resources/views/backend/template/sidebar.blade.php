    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse {{ request()->routeIs('panel.menu.*') || request()->routeIs('panel.chef.*') || request()->routeIs('panel.event.*') ? 'show' : '' }}" role="list" id="submenu-app" aria-expanded="false">
                    <ul class="flex-column nav">
                        ...
                        <li class="nav-item {{ request()->routeIs('panel.event.*') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('panel.event.index') }}">
                                <span class="sidebar-icon"><i class="fas fa-calendar-alt me-2"></i></span>
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse {{ request()->routeIs('panel.image.*') || request()->routeIs('panel.video.*') ? 'show' : '' }}" role="list" id="submenu-gallery" aria-expanded="false">
                    <ul class="flex-column nav">
