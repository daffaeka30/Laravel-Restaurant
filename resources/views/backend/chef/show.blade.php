    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Chef {{ $chef->name }}</h1>
                <p class="mb-0">Detail Chef Yummy Restoran</p>
            </div>
            <div>
    ...
    <div class="card border-0 shadow mb-4">
        <div class="card-body">
            <table class="table table-striped">
                ...
                <tr>
                    <th>Image</th>
                    <td width="60%">: <img src="{{ asset('storage/' . $chef->photo . '') }}" class="img-fluid" target="_blank" width="20%"></td>
                </tr>
                <tr>
                    <th>Instagram</th>
            ...
            <div class="float-end mt-3">
                <a href="{{ route('panel.chef.edit', $chef->uuid) }}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i> Edit</a>
            </div>
